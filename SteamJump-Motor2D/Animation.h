...
public:
	...
	//Description: If animation finish switch finished to true (Used in module continue fire animatino)
	SDL_Rect& GetFrameEx()
	{
		current_frame += speed;
		if (current_frame >= numFrames)
	...
	//Description: This runs an animation from 0 to its maximum and from its maximum to 0 indefinitely
